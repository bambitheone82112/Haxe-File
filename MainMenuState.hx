...
{
	public static var psychEngineVersion:String = 'V1 (DEMO)'; //This is also used for Discord RPC
	...
	var optionShit:Array<String> = ['freeplay', #if ACHIEVEMENTS_ALLOWED 'awards', #end 'credits',#end 'options'];
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Delusional Engine v" + psychEngineVersion, 12);
